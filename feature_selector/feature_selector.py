    ...
    def identify_zero_importance(self, task, eval_metric=None, 
        ...
        for _ in range(n_iterations):
            ...
            if early_stopping:
                ...
                if task == 'classification':
                	train_features, valid_features, train_labels, valid_labels = train_test_split(features, labels, test_size = 0.33, stratify=labels, random_state=1234567)
                else:
                	train_features, valid_features, train_labels, valid_labels = train_test_split(features, labels, test_size = 0.33, random_state=1234567)
